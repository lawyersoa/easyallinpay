...
class SetPayPwd extends RequestReqParam
{
    /**
     * @var string 商户用户ID
     */
     ...
     * @return SetPayPwd
     */
    public function setJumpPageType(int $jumpPageType): SetPayPwd
    {
     ...
     * @return SetPayPwd
     */
    public function setPhone(string $phone): SetPayPwd
    {
        $this->phone = $phone;
        return $this;
    }
     ...
     * @return SetPayPwd
     */
    public function setName(string $name): SetPayPwd
    {
        $this->name = $name;
        return $this;
    }
     ...
     * @return SetPayPwd
     */
    public function setIdentityType(int $identityType): SetPayPwd
    {
     ...
     * @return SetPayPwd
     */
    public function setIdentityNo(string $identityNo): SetPayPwd
    {
     ...
     * @return SetPayPwd
     */
    public function setJumpUrl(string $jumpUrl): SetPayPwd
    {
     ...
     * @return SetPayPwd
     */
    public function setErrorJumpUrl(string $errorJumpUrl): SetPayPwd
    {
     ...
     * @return SetPayPwd
     */
    public function setBackUrl(string $backUrl): SetPayPwd
    {
