...
class QueryBankCard extends RequestReqParam
{
    /**
     * @var string 商户用户ID
     */
     ...
     */
    public function setBizUserId(string $bizUserId): QueryBankCard
    {
     ...
     * @return QueryBankCard
     */
    public function setCardNo(string $cardNo): QueryBankCard
    {
        $this->cardNo = $cardNo;
        return $this;
    }
