...
class ResetPayPwd extends RequestReqParam
{
    /**
     * @var string 商户用户ID
     */
     ...
     * @return ResetPayPwd
     */
    public function setBizUserId(string $bizUserId): ResetPayPwd
    {
     ...
     * @return ResetPayPwd
     */
    public function setJumpPageType(int $jumpPageType): ResetPayPwd
    {
     ...
     * @return ResetPayPwd
     */
    public function setPhone(string $phone): ResetPayPwd
    {
        $this->phone = $phone;
        return $this;
    }
     ...
     * @return ResetPayPwd
     */
    public function setName(string $name): ResetPayPwd
    {
        $this->name = $name;
        return $this;
    }
     ...
     * @return ResetPayPwd
     */
    public function setIdentityType(int $identityType): ResetPayPwd
    {
     ...
     * @return ResetPayPwd
     */
    public function setIdentityNo(string $identityNo): ResetPayPwd
    {
     ...
     * @return ResetPayPwd
     */
    public function setJumpUrl(string $jumpUrl): ResetPayPwd
    {
     ...
     * @return ResetPayPwd
     */
    public function setErrorJumpUrl(string $errorJumpUrl): ResetPayPwd
    {
     ...
     * @return ResetPayPwd
     */
    public function setBackUrl(string $backUrl): ResetPayPwd
    {
