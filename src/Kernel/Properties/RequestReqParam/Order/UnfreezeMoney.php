...
class UnfreezeMoney extends RequestReqParam
{
    /**
     * @var string 商户用户ID
     */
     ...
     */
    public function setBizUserId(string $bizUserId): UnfreezeMoney
    {
     ...
     * @return UnfreezeMoney
     */
    public function setAccountSetNo(string $accountSetNo): UnfreezeMoney
    {
