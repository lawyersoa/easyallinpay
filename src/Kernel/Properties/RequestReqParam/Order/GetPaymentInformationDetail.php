...
class GetPaymentInformationDetail extends RequestReqParam
{
    /**
     * @var string 商户订单编号
     */
     ...
     */
    public function setBizOrderNo(string $bizOrderNo): GetPaymentInformationDetail
    {
     ...
     * @return GetPaymentInformationDetail
     */
    public function setBizUserId(string $bizUserId): GetPaymentInformationDetail
    {
     ...
     * @return GetPaymentInformationDetail
     */
    public function setAccountSetNo(string $accountSetNo): GetPaymentInformationDetail
    {
     ...
     * @return GetPaymentInformationDetail
     */
    public function setDateStart(string $dateStart): GetPaymentInformationDetail
    {
     ...
     * @return GetPaymentInformationDetail
     */
    public function setDateEnd(string $dateEnd): GetPaymentInformationDetail
    {
