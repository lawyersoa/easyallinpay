...
class ConsumeApply extends ResponseSignedValue
{
    /**
     * @var string 支付状态
     */
     ...
     * @return ConsumeApply
     */
    public function setPayStatus(string $payStatus): ConsumeApply
    {
     ...
     * @return ConsumeApply
     */
    public function setPayFailMessage(string $payFailMessage): ConsumeApply
    {
     ...
     * @return ConsumeApply
     */
    public function setBizUserId(string $bizUserId): ConsumeApply
    {
     ...
     * @return ConsumeApply
     */
    public function setOrderNo(string $orderNo): ConsumeApply
    {
     ...
     * @return ConsumeApply
     */
    public function setBizOrderNo(string $bizOrderNo): ConsumeApply
    {
     ...
     * @return ConsumeApply
     */
    public function setReqPayInterfaceNo(string $reqPayInterfaceNo): ConsumeApply
    {
     ...
     * @return ConsumeApply
     */
    public function setPayInterfaceOutTradeNo(string $payInterfaceOutTradeNo): ConsumeApply
    {
     ...
     * @return ConsumeApply
     */
    public function setPayCode(string $payCode): ConsumeApply
    {
     ...
     * @return ConsumeApply
     */
    public function setTradeNo(string $tradeNo): ConsumeApply
    {
     ...
     * @return ConsumeApply
     */
    public function setWeChatAPPInfo(string $weChatAPPInfo): ConsumeApply
    {
     ...
     * @return ConsumeApply
     */
    public function setPayInfo(string $payInfo): ConsumeApply
    {
