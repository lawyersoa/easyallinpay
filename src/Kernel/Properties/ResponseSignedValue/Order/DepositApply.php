...
class DepositApply extends ResponseSignedValue
{
    /**
     * @var string 支付状态
     */
     ...
     * @return DepositApply
     */
    public function setPayStatus(string $payStatus): DepositApply
    {
     ...
     * @return DepositApply
     */
    public function setPayFailMessage(string $payFailMessage): DepositApply
    {
     ...
     * @return DepositApply
     */
    public function setOrderNo(string $orderNo): DepositApply
    {
     ...
     * @return DepositApply
     */
    public function setBizOrderNo(string $bizOrderNo): DepositApply
    {
     ...
     * @return DepositApply
     */
    public function setReqPayInterfaceNo(string $reqPayInterfaceNo): DepositApply
    {
     ...
     * @return DepositApply
     */
    public function setPayInterfaceOutTradeNo(string $payInterfaceOutTradeNo): DepositApply
    {
     ...
     * @return DepositApply
     */
    public function setPayCode(string $payCode): DepositApply
    {
     ...
     * @return DepositApply
     */
    public function setTradeNo(string $tradeNo): DepositApply
    {
     ...
     * @return DepositApply
     */
    public function setWeChatAPPInfo(string $weChatAPPInfo): DepositApply
    {
     ...
     * @return DepositApply
     */
    public function setPayInfo(string $payInfo): DepositApply
    {
