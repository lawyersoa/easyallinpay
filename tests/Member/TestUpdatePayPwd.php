...
use EasyAllInPay\Kernel\Properties\RequestReqParam\Member\UpdatePayPwd;
...
$updatePayPwdRequest = new UpdatePayPwd();
try {
    $updatePayPwdRequest
    ...
    ;
    $updatePayPwdResponse = $member->updatePayPwd($updatePayPwdRequest);
    var_dump($updatePayPwdResponse);
} catch (Exception $e) {
