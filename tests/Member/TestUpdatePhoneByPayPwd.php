...
use EasyAllInPay\Kernel\Properties\RequestReqParam\Member\UpdatePhoneByPayPwd;
...
$updatePhoneByPayPwdRequest = new UpdatePhoneByPayPwd();
try {
    $updatePhoneByPayPwdRequest
        ...
        ->setOldPhone('13200000000') //原手机 必填
    ...
    ;
    $updatePhoneByPayPwdResponse = $member->updatePhoneByPayPwd($updatePhoneByPayPwdRequest);
    var_dump($updatePhoneByPayPwdResponse);
} catch (Exception $e) {
