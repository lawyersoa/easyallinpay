...
use EasyAllInPay\Kernel\Properties\RequestReqParam\Member\ResetPayPwd;
...
$resetPayPwdRequest = new ResetPayPwd();
try {
    $resetPayPwdRequest
    ...
    ;
    $resetPayPwdResponse = $member->resetPayPwd($resetPayPwdRequest);
    var_dump($resetPayPwdResponse);
} catch (Exception $e) {
