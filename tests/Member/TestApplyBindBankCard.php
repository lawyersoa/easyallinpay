...
use EasyAllInPay\Kernel\Properties\RequestReqParam\Member\ApplyBindBankCard;
...
$applyBindBankCardRequest = new ApplyBindBankCard();
try {
    $applyBindBankCardRequest
        ...
        ->setCvv2('123') //CVV2 可选
        ->setUnionBank('123456') //支付行号 可选
    ;
    $applyBindBankCardResponse = $member->applyBindBankCard($applyBindBankCardRequest);
    var_dump($applyBindBankCardResponse);
    //var_dump($applyBindBankCardResponse->toArray());
} catch (Exception $e) {
